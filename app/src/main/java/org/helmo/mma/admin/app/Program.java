...
import org.helmo.mma.admin.domains.reservation.validator.RoomAvailabilityValidator;
...
public class Program {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<ReservationValidator> reservationValidators = List.of(new RoomAvailabilityValidator());
